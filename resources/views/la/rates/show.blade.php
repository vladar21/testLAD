...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $rate->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Rates", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/rates/'.$rate->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Rates", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.rates.destroy', $rate->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/rates') }}" data-toggle="tooltip" data-placement="right" title="Back to Rates"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'USD')
						@la_display($module, 'EUR')
						@la_display($module, 'GBP')
						@la_display($module, 'RUB')
						@la_display($module, 'UAH')
					</div>
				</div>
			</div>
		</div>
